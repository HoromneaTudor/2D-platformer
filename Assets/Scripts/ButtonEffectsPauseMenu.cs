...
public class ButtonEffectsPauseMenu : MonoBehaviour,ISelectHandler
{
    ...
    void Update()
    {
        ...
        if (currentSelected == button && once)
        {
            ...
            button.transform.DOShakePosition(0.1f, new Vector3(0, 10, 0), 20, 0, false, true).SetUpdate(true);

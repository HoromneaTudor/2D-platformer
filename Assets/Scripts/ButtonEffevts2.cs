...
public class ButtonEffevts2 : MonoBehaviour,ISelectHandler
{
    ...
    void Update()
    {
        ...
        if ((currentSelected == button && once)|| (currentSelected == button && (xRaw>0.9||xRaw<-0.9||xLeftKey||xRightKey)))
        {
            button.transform.DOComplete();
            button.transform.DOShakePosition(0.1f, new Vector3(0, 10, 0), 20, 0, false, true);
